...
**Today Progress** Working with Min Height BST. Write function that takes non empty array of distinct integers construct a BST from integers and return the root the BST. System, Desiggn Rate Limiting Topic not finsished yet very great topic.
